...
public class HashMap<K,V> extends AbstractMap<K,V>
     ...
     */
    RuntimeHelper rh_hashmap = new RuntimeHelper();
    class RuntimeHelper {
    ...
    public Set<Map.Entry<K,V>> entrySet() {
        ...
        return (es = rh_hashmap.entrySet) == null ? (rh_hashmap.entrySet = new EntrySet()) : es;
    }
    ...
    void reinitialize() {
        table = null;
        rh_hashmap.entrySet = null;
        rh_abstractmap.keySet = null;
        rh_abstractmap.values = null;
        modCount = 0;
        threshold = 0;
        size = 0;
    }
