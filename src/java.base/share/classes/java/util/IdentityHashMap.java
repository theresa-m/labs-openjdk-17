    ...
    implements Map<K,V>, java.io.Serializable, Cloneable
{
    ...
    public Object clone() {
        try {
            ...
            m.rh_identityhashmap.entrySet = null;
            m.table = table.clone();
            return m;
     ...
     */
    private RuntimeHelper rh_identityhashmap = new RuntimeHelper();
    class RuntimeHelper {
    ...
    public Set<Map.Entry<K,V>> entrySet() {
        Set<Map.Entry<K,V>> es = rh_identityhashmap.entrySet;
        if (es != null)
            return es;
        else
            return rh_identityhashmap.entrySet = new EntrySet();
    }
